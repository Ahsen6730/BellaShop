	...
	styleUI : {
		jQueryUI : {
			...
			colmenu : {
				...
				icon_sasc : "ui-icon-arrow-1-n",
				icon_sdesc : "ui-icon-arrow-1-s",
		...
		Bootstrap : {
			...
			colmenu : {
				...
				icon_sasc : "glyphicon-sort-by-alphabet",
				icon_sdesc : "glyphicon-sort-by-alphabet-alt",
...
$.fn.jqGrid = function( pin ) {
	...
	return this.each( function() {
		...
		buildColMenu = function( index, left, top ){
			...
			// sorting
			if(op.sorting) {
				str += '<li class="ui-menu-item" role="presentation"><a class="g-menu-item" tabindex="0" role="menuitem" value="sortasc"><table class="ui-common-table"><tr><td class="menu_icon"><span class="'+iconbase+' '+colmenustyle.icon_sasc+'"></span></td><td class="menu_text">'+texts.sortasc+'</td></tr></table></a></li>';
				str += '<li class="ui-menu-item" role="presentation"><a class="g-menu-item" tabindex="0" role="menuitem" value="sortdesc"><table class="ui-common-table"><tr><td class="menu_icon"><span class="'+iconbase+' '+colmenustyle.icon_sdesc+'"></span></td><td class="menu_text">'+texts.sortdesc+'</td></tr></table></a></li>';
			}
			if(op.columns) {
